  ...
  return (
    ...
    >
      ...
      <div className="p-6 pb-4">
        <div className="tyext-xl tracking-tight text-slate-800 flex items-center gap-1.5">
      ...
      <div className="p-4 border-t border-slate-100">
        ...
        <button
          onClick={logout}
          className="mt-1 flex items-center gap-2 px-3 py-2 w-full roundd text-sm text-slate-500 hover:bg-red-50 hover:text-red-500 transition-all duration-150"
        >
